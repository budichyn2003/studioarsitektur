  ...
  return (
    <div className="w-full min-h-screen pt-16 pb-24 px-6 md:px-12 lg:pl-[320px] xl:pl-[380px] pr-6 md:pr-16 flex flex-col">
      <div className="flex justify-end mb-12 gap-6">
        <div className="w-8 h-4 bg-gray-200 animate-pulse rounded-full"></div>
        <div className="w-20 h-4 bg-gray-200 animate-pulse rounded-full"></div>
        <div className="w-16 h-4 bg-gray-200 animate-pulse rounded-full"></div>
